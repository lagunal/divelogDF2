...
class DiveSession {
  ...
  final String buque; // Buque/Instalación
  final String operadoraBuceo;
  final String direccionOperadora;
  final String lugarBuceo;
  final String
      tipoBuceo; // Scuba, Asist. Superficie, Altura Geográfica, Saturación
  ...
  Map<String, dynamic> toFirestore() => {
        ...
        'inicioDescompresion': inicioDescompresion != null
            ? Timestamp.fromDate(inicioDescompresion!)
            : null,
        'descompresionCompleta': descompresionCompleta != null
            ? Timestamp.fromDate(descompresionCompleta!)
            : null,
  ...
  factory DiveSession.fromJson(Map<String, dynamic> json) {
    ...
    return DiveSession(
      ...
      buque: json['buque'] != null ? json['buque'] as String : '',
      ...
      tiempoIntervaloSuperficie:
          (json['tiempoIntervaloSuperficie'] as num).toDouble(),
      ...
      tiempoSupervisionAcumulado:
          (json['tiempoSupervisionAcumulado'] as num).toDouble(),
  ...
  factory DiveSession.fromFirestore(Map<String, dynamic> data) => DiveSession(
        ...
        buque: data['buque'] != null ? data['buque'] as String : '',
        ...
        tiempoIntervaloSuperficie:
            (data['tiempoIntervaloSuperficie'] as num).toDouble(),
        tiempoFondo: (data['tiempoFondo'] as num).toDouble(),
        inicioDescompresion: data['inicioDescompresion'] != null
            ? (data['inicioDescompresion'] as Timestamp).toDate()
            : null,
        descompresionCompleta: data['descompresionCompleta'] != null
            ? (data['descompresionCompleta'] as Timestamp).toDate()
            : null,
        ...
        tiempoSupervisionAcumulado:
            (data['tiempoSupervisionAcumulado'] as num).toDouble(),
  ...
  DiveSession copyWith({
    ...
    DateTime? updatedAt,
      ...
      DiveSession(
        ...
        tiempoIntervaloSuperficie:
            tiempoIntervaloSuperficie ?? this.tiempoIntervaloSuperficie,
        tiempoFondo: tiempoFondo ?? this.tiempoFondo,
        inicioDescompresion: inicioDescompresion ?? this.inicioDescompresion,
        descompresionCompleta:
            descompresionCompleta ?? this.descompresionCompleta,
        ...
        descompresionUtilizada:
            descompresionUtilizada ?? this.descompresionUtilizada,
        enfermedadLesion: enfermedadLesion ?? this.enfermedadLesion,
        tiempoSupervisionAcumulado:
            tiempoSupervisionAcumulado ?? this.tiempoSupervisionAcumulado,
